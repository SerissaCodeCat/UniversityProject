                      ...
                      EKeyCode turnCW, EKeyCode turnCCW, EKeyCode moveForward, EKeyCode moveBackward )
{
	...
	{
		m_Position.x += m_WorldMatrix._31 * MoveSpeed * frameTime * 0.2f;
		m_Position.y += m_WorldMatrix._32 * MoveSpeed * frameTime * 0.2f;
		m_Position.z += m_WorldMatrix._33 * MoveSpeed * frameTime * 0.2f;
	}
